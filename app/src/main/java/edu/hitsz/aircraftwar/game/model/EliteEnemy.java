...
public class EliteEnemy extends AbstractAircraft {
    ...
    public EliteEnemy(float locationX, float locationY, float speedX, float speedY, int hp, int width, int height) {
        super(locationX, locationY, speedX, speedY, hp, width, height, SpriteType.ELITE_ENEMY);
    }
